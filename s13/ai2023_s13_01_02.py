...
#
# Time-stamp: <2023/12/07 20:30:17 (Taiwan_Standard_Time_UT+8) daisuke>
#
...
header['comment'] = "making 2-D sky background map image"
...
# writing a FITS file
astropy.io.fits.writeto (file_output, image_skybg.background, header=header)
