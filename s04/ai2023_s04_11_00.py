...
#
# Time-stamp: <2023/10/01 16:58:28 (CST) daisuke>
#
...
descr  = f'3D structure of inner solar system #1'
...
parser.add_argument ('-d', '--dir', default='solsys_3d1', \
                     help='directory to put output files (default: solsys_3d1)')
