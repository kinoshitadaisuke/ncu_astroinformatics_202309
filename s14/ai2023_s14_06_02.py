...
#
# Time-stamp: <2023/12/15 14:43:32 (Taiwan_Standard_Time_UT+8) daisuke>
#
...
# printing status
print (f'Now, searching for Jovian Trojan asteroids...')
...
# printing status
print (f'Finished searching for Jovian Trojan asteroids!')

# printing status
print (f'Now, adding Jovian Trojan asteroids to the simulation...')
