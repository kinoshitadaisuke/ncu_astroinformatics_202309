...
#
# Time-stamp: <2023/12/24 00:36:54 (Taiwan_Standard_Time_UT+8) daisuke>
#
...
# URL of data file
url_data = 'https://sbnarchive.psi.edu/pds4/non_mission/neowise_diameters_albedos_V2_0.zip'

# output file name
file_output = 'neowise_albedo.zip'
