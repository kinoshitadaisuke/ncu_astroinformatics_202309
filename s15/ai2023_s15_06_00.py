...
#
# Time-stamp: <2023/12/23 19:03:54 (Taiwan_Standard_Time_UT+8) daisuke>
#
...
# URL of data file
url_data = 'https://sbnarchive.psi.edu/pds4/non_mission/compil.ast.ubv-photometry.zip'

# output file name
file_output = 'colour_ubv.zip'
