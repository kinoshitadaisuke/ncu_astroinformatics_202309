...
#
# Time-stamp: <2023/12/23 22:36:15 (Taiwan_Standard_Time_UT+8) daisuke>
#
...
# URL of data file
url_data = 'https://sbnarchive.psi.edu/pds4/non_mission/gbo.sdss-moc.phot.zip'

# output file name
file_output = 'sdss_moc.zip'
